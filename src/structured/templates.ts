...
import type {StringTemplate, Template, ObjectTemplate, ArrayTemplate, MapTemplate} from './types';
...
export const userProfile: ObjectTemplate = ['obj', [
  ['id', ['int', 1, 10000]],
...
export const userBasic: ObjectTemplate = ['obj', [
  ['id', ['int', 1, 1000]],
  ['name', ['str', ['list', 
...
export const apiResponse: ObjectTemplate = ['obj', [
...
export const apiResponseDetailed: ObjectTemplate = ['obj', [
  ['success', ['lit', true]],
...
export const serviceConfig: ObjectTemplate = ['obj', [
  ['database', ['obj', [
...
export const configMap: MapTemplate = ['map',
  ['pick', 'timeout', 'retries', 'cache_ttl', 'max_connections'],
  ['int', 1, 3600],
  3, 5
];

export const permissions: MapTemplate = ['map',
  ['list', 'can_', ['pick', 'read', 'write', 'delete', 'admin']],
  'bool',
  2, 6
];

export const translations: MapTemplate = ['map',
...
export const product: ObjectTemplate = ['obj', [
...
export const userToken: ObjectTemplate = ['obj', [
...
export const logEntry: ObjectTemplate = ['obj', [
...
export const metricData: ObjectTemplate = ['obj', [
...
export const coordinates: ArrayTemplate = ['arr', 0, 0, 'nil', 
  [['float', -180, 180], ['float', -90, 90]], // head: [longitude, latitude]
  [['lit', 'WGS84']]                          // tail: coordinate system
];

export const address: ObjectTemplate = ['obj', [
  ['street', ['str', ['list', ['char', 48, 57, 3], ' ', ['pick', 'Main St', 'Oak Ave', 'Pine Rd', 'Elm St', 'Maple Dr']]]],
  ['city', ['str', ['pick', 'New York', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix', 'Philadelphia', 'San Antonio']]],
...
export const location: ObjectTemplate = ['obj', [
  ['name', ['str', ['list', 
...
export const transaction: ObjectTemplate = ['obj', [
  ['id', ['str', ['list', 'txn_', ['char', 97, 122, 8], ['char', 48, 57, 8]]]],
  ['amount', ['float', 0.01, 10000.00]],
...
export const socialProfile: ObjectTemplate = ['obj', [
  ['username', ['str', tokenUsername]],
...
export const sensorReading: ObjectTemplate = ['obj', [
...
export const iotDevice: ObjectTemplate = ['obj', [
  ...
  ['firmwareVersion', ['str', ['list', 
    ['char', 49, 57], '.', ['char', 48, 57], '.', ['char', 48, 57]
  ]]],
  ['ipAddress', ['str', ['list', 
    '192.168.', ['char', 48, 57, 1], '.', ['char', 48, 57, 3]
  ]]],
  ['macAddress', ['str', ['list',
    ['char', 48, 57, 2], ':', ['char', 48, 57, 2], ':', ['char', 48, 57, 2], ':',
    ['char', 48, 57, 2], ':', ['char', 48, 57, 2], ':', ['char', 48, 57, 2]
  ]]],
...
export const patient: ObjectTemplate = ['obj', [
...
export const medicalRecord: ObjectTemplate = ['obj', [
  ['recordId', ['str', ['list', 'MED-', ['char', 48, 57, 10]]]],
  ['patientId', ['str', ['list', 'PAT-', ['char', 48, 57, 8]]]],
  ['visitDate', ['int', Date.now() - 31536000, Date.now()]], // Last year
  ['provider', ['obj', [
    ['name', ['str', ['list', 'Dr. ', ['pick', 'John', 'Jane', 'Michael', 'Sarah'], ' ', ['pick', 'Smith', 'Johnson', 'Williams']]]],
...
export const student: ObjectTemplate = ['obj', [
  ...
  ['major', ['str', ['pick', 'Computer Science', 'Biology', 'Mathematics', 'English', 'History', 'Physics', 'Chemistry']], 0.7],
  ['gpa', ['float', 2.0, 4.0]],
  ['enrollmentDate', ['int', 1567296000, Date.now()]] // From 2019
]];

export const course: ObjectTemplate = ['obj', [
  ...
  ['credits', ['int', 1, 6]],
  ['instructor', ['obj', [
    ['name', ['str', ['list', 'Prof. ', ['pick', 'John', 'Jane', 'Michael', 'Sarah'], ' ', ['pick', 'Smith', 'Johnson', 'Williams']]]],
    ['email', ['str', tokenEmail]],
    ['office', ['str', ['list', ['char', 65, 90], '-', ['char', 48, 57, 3]]]]
  ]]],
  ['schedule', ['obj', [
    ['days', ['arr', 1, 3, ['str', ['pick', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday']]]],
    ['time', ['str', ['list', ['char', 48, 57, 2], ':', ['pick', '00', '30'], '-', ['char', 48, 57, 2], ':', ['pick', '00', '30']]]],
...
export const grade: ObjectTemplate = ['obj', [
  ['studentId', ['str', ['list', 'STU-', ['char', 48, 57, 7]]]],
  ['courseId', ['str', ['list', ['char', 65, 90, 3], '-', ['char', 48, 57, 3]]]],
  ['semester', ['str', ['pick', 'Fall 2023', 'Spring 2024', 'Summer 2024', 'Fall 2024']]],
  ['assignments', ['arr', 3, 8, ['obj', [
    ['name', ['str', ['list', 
      ['pick', 'Assignment', 'Quiz', 'Exam', 'Project', 'Lab'],
      ' ',
      ['char', 48, 57, 1]
    ]]],
    ['score', ['float', 0, 100]],
...
export const emptyStructures: ObjectTemplate = ['obj', [
  ['emptyObject', ['obj', []]],
  ['emptyArray', ['arr', 0, 0]],
  ['emptyString', ['lit', '']],
  ['nullValue', 'nil'],
...
export const unicodeText: ObjectTemplate = ['obj', [
...
export const largeNumbers: ObjectTemplate = ['obj', [
...
export const performanceTest: ArrayTemplate = ['arr', 100, 1000, ['obj', [
  ['id', ['int', 1, 1000000]],
...
export const mixedTypes: Template = ['or',
  'str',
  'int', 
  'float',
  'bool',
...
export const loadTestUser: ObjectTemplate = ['obj', [
  ['id', ['int', 1, 10000]],
  ['name', ['str', ['list', 
    ['pick', 'John', 'Jane', 'Bob', 'Alice', 'Charlie'],
    ' ',
